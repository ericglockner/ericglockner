...
@property (nonatomic, strong) CAShapeLayer *lineLeft;
@property (nonatomic, strong) CAShapeLayer *lineTop;
@property (nonatomic, strong) CAShapeLayer *lineRight;
@property (nonatomic, strong) CAShapeLayer *lineBottom;
@property CGPoint tapPoint;
@property NSMutableArray *rippleAnimationQueue;
@property NSMutableArray *deathRowForCircleLayers;
@property int checkboxSidesCompletedAnimating;          
@property int checkmarkSidesCompletedAnimating;         
